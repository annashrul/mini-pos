...
export function ReturnsContent() {
  ...
  const canCreate = canAction("create") && canPlan("returns", "create");
  const canApprove = canAction("approve") && canPlan("returns", "approve");
  const canReject = canAction("reject") && canPlan("returns", "reject");
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
        ...
        <div className="hidden sm:flex items-center gap-2">
          ...
          >
            <Button
              ...
              disabled={!canCreate}
              className="bg-gradient-to-r from-violet-500 to-purple-600 hover:from-violet-600 hover:to-purple-700 text-white shadow-lg shadow-violet-200 rounded-xl gap-2 text-xs sm:text-sm"
            >
      ...
      <SmartTable<ReturnRow>
        ...
        planMenuKey="returns" exportModule="returns"
