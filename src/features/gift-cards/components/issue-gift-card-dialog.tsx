    ...
    const onSubmit = (data: GiftCardFormValues) => {
        ...
        startTransition(async () => {
            ...
            if (result.error) {
                ...
                toast.success(
                    "Gift card berhasil diterbitkan",
                    { duration: 6000 }
                );
                reset();
                setIsCustom(false);
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                {presetAmounts.map((preset) => (
                                    <button
                                        ...
                                        className={`px-4 py-3 rounded-xl border text-sm font-semibold transition-all ${!isCustom && watchedAmount === preset
                            ...
                            <div className="relative">
                                <Input
                                    ...
                                    className={`rounded-xl ${isCustom && customAmount
