...
export function GiftCardsContent() {
    ...
    const canCreate = canAction("create") && canPlan("gift-cards", "create");
    const canUpdate = canAction("update") && canPlan("gift-cards", "update");
    const canDisable = canAction("disable") && canPlan("gift-cards", "disable");
