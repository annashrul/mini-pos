                        ...
                        <div className="p-3 sm:p-5 space-y-3 sm:space-y-4">
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <Input type="number" value={ctx.discountPercent} onChange={(e) => ctx.setDiscountPercent(Number(e.target.value))} className="w-12 sm:w-14 h-7 text-right rounded-md text-xs" min={0} max={100} />
                                    <span className="text-xs text-muted-foreground">%</span>
                                </div>
                                {ctx.discountAmount > 0 && <div className="flex justify-between text-xs sm:text-sm text-red-500">
                                    <span>Diskon</span>
